...
Color4F::Color4F(const Color3B &color, float _a)
        : r(color.r / 255.0f), g(color.g / 255.0f), b(color.b / 255.0f), a(_a) {
}
...
bool Color4F::isVisible() const {
    return !equals(Color4F::TRANSPARENT);
}
...
const Color4B Color4B::TRANSPARENT(255, 255, 255, 0);
...
const Color4F Color4F::TRANSPARENT(1, 1, 1, 0);
