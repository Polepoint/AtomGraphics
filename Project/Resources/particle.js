...
var PI = Math.PI, cos = Math.cos, sin = Math.sin, abs = Math.abs, random = Math.random, atan2 = Math.atan2;
var TAU = 2 * PI;
    ...
    var particle = {
        ...
        update: function update() {
            var _position2 = _slicedToArray(
                this.position, 2), x = _position2[0], y = _position2[1];
...
function mouseHandler(event) {
    var type = event.type, clientX = event.clientX, clientY = event.clientY;
